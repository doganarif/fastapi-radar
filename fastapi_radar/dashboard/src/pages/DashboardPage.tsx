    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <MetricCard
          ...
          change={undefined}
          changeLabel={`${metrics.requestsPerMinute.toFixed(1)} ${t('metrics.requestsPerMinute').toLowerCase()}`}
        ...
        <MetricCard
          ...
          changeLabel={
            metrics.avgResponseTime < 100 ? t('common.loading') : t('common.error')
          }
        ...
        <MetricCard
          ...
          changeLabel={
            stats?.slow_queries ? `${stats.slow_queries} ${t('metrics.slowQueries').toLowerCase()}` : t('common.all')
          }
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base">{t('performance.overview')}</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base">{t('performance.requestDistribution')}</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <AreaChart
          ...
          data={timeSeriesData}
          areas={[{ dataKey: "response", name: t('metrics.responseTime') + " (ms)" }]}
          height={200}
          formatter="duration"
        />
      ...
      {endpointData.length > 0 && (
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-base">{t('performance.topEndpoints')}</CardTitle>
            ...
            <CardDescription>{t('performance.avgResponseByEndpoint')}</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-base">{t('performance.recentRequests')}</CardTitle>
              <Button variant="ghost" size="sm" asChild>
                <Link to="/requests">
                  {t('common.view')} {t('common.all')}
                  <ArrowUpRight className="ml-1 h-3 w-3" />
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-base">{t('database.slowQueries')}</CardTitle>
              <Button variant="ghost" size="sm" asChild>
                <Link to="/database">
                  {t('common.view')} {t('common.all')}
                  <ArrowUpRight className="ml-1 h-3 w-3" />
      ...
      {recentExceptions && recentExceptions.length > 0 && (
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-base">{t('exceptions.recentExceptions')}</CardTitle>
              <Button variant="ghost" size="sm" asChild>
                <Link to="/exceptions">
                  {t('common.view')} {t('common.all')}
                  <ArrowUpRight className="ml-1 h-3 w-3" />
